...
cat("9. 生成补充分析报告\n")
cat("========================================================\n")
report_file <- file.path(LOGS_DIR, "10_paper1_supp_report_L.txt")
sink(report_file)
cat("论文1补充分析报告\n")
cat("==================\n\n")
...
# ============================================================================
cat("10. 保存会话信息...\n")
session_info_path <- file.path(LOGS_DIR, "10_session_info_L.txt")
...
code_list_path <- file.path(LOGS_DIR, "10_code_list_L.txt")
